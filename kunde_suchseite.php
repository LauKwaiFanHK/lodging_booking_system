...
<body>
	...
	<nav class="navbar navbar-inverse">
		<div class="container-fluid">
			...
			<ul class="nav navbar-nav navbar-right">
				...
				<li><a href="hilfe.php"><span class="glyphicon glyphicon-question-sign"></span>Hilfe</a></li>
	...
	<div class="container">
		<form action="showResults2.php" method="post">
				...
				<div class="card-body">
					...
					<input type="hidden" name='KundeID' value='<?php echo $KundeID ?>'>
						...
						<div class="col-md-3 text-center custom-control custom-checkbox">
							<label>Sehenswürdigkeiten anzeigen?</label>
							<input type="checkbox" class="custom-control-input" name="Sehenswurdigkeiten" value="yes" 
							id="customCheck1" data-toggle="tooptip" data-placement="bottom" title="Wählen Sie aus, um die Sehenswürdigkeiten in der Nähe anzusehen." 
