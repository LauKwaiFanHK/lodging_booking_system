...
<body>
    ...
    if (!empty($city)) {
        ...
        $cities = mysqli_query($connection, "select * from Gebäude where Stadt = '{$city}'");
            ...
            if (!empty($numberOfGuests)) {
                $filter['Größe'] = "Zimmer.Kapazität >= {$numberOfGuests}";
                }
    ...
    <div class='container mt-5'>
        <div class="row align-center">
            <?if(!$result){?>
            <h2 class="bold">Nichts gefunden, <a href="/kunde_suchseite.php"> zurückkehren</a></h2>
            <?} else {?>
