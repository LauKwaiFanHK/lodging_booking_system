...
<body translate="no">
    ...
    <nav class="navbar navbar-inverse">
        <div class="container-fluid">
            <div class="navbar-header">
                <!-- direct to frontpage!-->
                <a class="navbar-brand" href="frontpage.php"><strong>FeelsLikeHome</strong></a>
            </div>
    ...
    <main>
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                <div class="row">
                    <div class="col-sm-8">
                        <button type="button" class="btn btn-info add-new" onclick="document.location='formular_neue_zimmerkategorie.php?AnbieterID=<?php echo $AnbieterID ?>&GebäudeID=<?php echo $GebäudeID ?>'">
    ...
    <footer>
        ...
        <p>Email: <a href="mailto:info@feelslikehome.com">feelslikehome@gmail.com</a></p>
        <p>Tel: +49 1527362859</p>
    </footer>
