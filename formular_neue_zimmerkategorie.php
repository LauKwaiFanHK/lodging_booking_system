...
<body translate="no">
    ...
    <main>
        <div class="col-md-7">
            ...
            ?>
            <form method="POST" action="insert_zimmerkategorie.php">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input placeholder="0.00" required name="Preis" min="0" value="0" step="0.01" title="Currency" id="inputPreis" class="form-control mx-sm-3">
                    </div>
                </div>
